...
class TemplatesController extends Controller {
    ...
    {
        return view('leadingdots.customemail.templates.list');
    }
    ...
    public function listTemplates(Request $request)
    {
        ...
        $data = [
            'rows' => view('leadingdots.customemail.templates.list_rows',
                [
                    'items' => $items,
                ]
            )->render(),
            'items' => $items,
            'pagination' => view('leadingdots.customemail.inc.pagination', ['result' => $items])->render(),
        ];
    ...
    public function create()
    {
        ...
        return view('leadingdots.customemail.templates.add', [
            "item" => false,
            "tokens" => $tokens
        ]);
    }
